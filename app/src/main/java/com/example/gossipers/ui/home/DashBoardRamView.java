...
public class DashBoardRamView extends View {
    private static final String TAG= DashBoardRamView.class.getSimpleName();
    ...
    private String legendName="ram使用率(%)";

    public DashBoardRamView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
