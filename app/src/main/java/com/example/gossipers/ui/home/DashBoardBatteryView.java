...
public class DashBoardBatteryView extends View {
    private static final String TAG= DashBoardBatteryView.class.getSimpleName();
    ...
    private float startscaleValue = 0;//开始刻度值
    private float endscaleValue = 100;//停止刻度值
    ...
    //弧分成三段颜色的颜色值
    private int[] arcColors = {Color.parseColor("#C23531"), Color.parseColor("#63869E"),
            Color.parseColor("#91C7AE")};
    ...
    private String legendName="电量(%)";

    public DashBoardBatteryView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
