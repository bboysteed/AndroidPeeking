...
public class DashBoardCPuView extends View {
    private static final String TAG= DashBoardCPuView.class.getSimpleName();
    ...
    private String legendName="cpu使用率(%)";

    public DashBoardCPuView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
